...
Classification in daily life. (Source : [Shubham](https://medium.com/analytics-vidhya/email-spam-classifier-using-naive-bayes-a51b8c6290d4))
...
We make predictions for classification using probabilities, that is if a particular observation X = x has a probability _p_ of belonging to a certain class Y = k that is above some predefined threshold, we classify it as belonging to class k_._
...
An example of a multi-class dummy variable. (Source : [ISL Python](https://www.statlearning.com/))
